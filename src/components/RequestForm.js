            ...
            <div className="request-content">
                <div className="request-card">
                    <div className="request-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#5b6b7d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
