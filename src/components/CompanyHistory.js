...
const events = [
  ...
  },
  {
    year: 2007,
    achievements: [
      "생물학적 여재를 이용한 오폐수처리장치 (특허 제10-0745444호)",
  ...
  },
  {
    year: 2011,
    achievements: [
      "하폐수 처리수 재이용 장치 빔 방법 특허 등록 (제10-1129292호)",
  ...
  },
  {
    year: 2013,
    achievements: [
      "패키지형 상수도 고도정수처리시설 특허 등록 (제10-1300438호)",
  ...
  },
  {
    year: 2014,
    achievements: [
      "(주)에덴 기업부설연구소 서울 사무실 (등록 제20140162호)",
  ...
  },
  {
    year: 2020,
    achievements: [
      "미세먼지 배출저감 및 위험회피 R&D 및 실증 (서울에너지공사)",
  ...
  },
  {
    year: 2022,
    achievements: [
      "체인형 회전체를 이용한 VOCs 농축 제거 시스템 특허 등록",
  ...
  },
  {
    year: 2023,
    achievements: [
      "이길리 집단이주마을 재해복구사업 하수처리장비 (강원도 철원군)",
